...
public class SyslogMessage implements Cloneable {
    ...
    public String toString() {
        return new StringJoiner(", ", SyslogMessage.class.getSimpleName() + "[", "]")
            .add("m_parserClass=" + m_parserClass)
            .add("m_facility=" + m_facility)
            .add("m_severity=" + m_severity)
            .add("m_version=" + m_version)
            .add("m_date=" + m_date)
            .add("m_year=" + m_year)
            .add("m_month=" + m_month)
            .add("m_dayOfMonth=" + m_dayOfMonth)
            .add("m_hourOfDay=" + m_hourOfDay)
            .add("m_minute=" + m_minute)
            .add("m_second=" + m_second)
            .add("m_millisecond=" + m_millisecond)
            .add("m_zoneId=" + m_zoneId)
            .add("m_hostname='" + m_hostname + "'")
            .add("m_processName='" + m_processName + "'")
            .add("m_processId='" + m_processId + "'")
            .add("m_messageId='" + m_messageId + "'")
            .add("m_message='" + m_message + "'")
            .add("m_parameters=" + m_parameters)
            .toString();
    }
