...
import org.opennms.horizon.syslog.config.HostaddrMatch;
import org.opennms.horizon.syslog.config.HostnameMatch;
import org.opennms.horizon.syslog.config.ParameterAssignment;
import org.opennms.horizon.syslog.config.ProcessMatch;
...
import org.opennms.horizon.syslog.parser.SyslogMessage;
import org.opennms.horizon.syslog.parser.SyslogParser;
import org.opennms.horizon.syslog.parser.SyslogParserException;
...
public class ConvertToEvent {
    ...
    public static final EventBuilder toEventBuilder(SyslogMessage message, String systemId, String location) {
        return toEventBuilder(message, systemId, location, null, null, null, null);
    }

    public static final EventBuilder toEventBuilder(SyslogMessage message, String systemId, String location,
                                                    Date receivedTimestamp,
                                                    LocationAwareDnsLookupClient locationAwareDnsLookupClient,
                                                    Cache<HostNameWithLocationKey, String> dnsCache, InterfaceToNodeCache interfaceToNodeCache) {
        if (message == null) {
            return null;
        }
        ...
        if (hostInetAddress != null) {
            // Set nodeId
            interfaceToNodeCache.getFirstNodeId(location, hostInetAddress)
    ...
    public ConvertToEvent(
        ...
        this(systemId, location, addr, port, incoming, null, config, locationAwareDnsLookupClient, null, null);
    }
    ...
    public ConvertToEvent(
            ...
            LocationAwareDnsLookupClient locationAwareDnsLookupClient,
            Cache<HostNameWithLocationKey, String> dnsCache,
            InterfaceToNodeCache interfaceToNodeCache) throws MessageDiscardedException {
        ...
        * node to match against nodeId.
        ...
        EventBuilder bldr = toEventBuilder(message, systemId, location, receivedTimestamp, m_locationAwareDnsLookupClient, dnsCache, interfaceToNodeCache);
